...
const EdgeResolver_1 = require("./resolvers/EdgeResolver");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function* () {
        const schema = yield type_graphql_1.buildSchema({
            resolvers: [ProjectResolver_1.default, TaskResolver_1.default, NodeResolver_1.default, EdgeResolver_1.default],
            emitSchemaFile: true,
        });
